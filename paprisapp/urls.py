...
urlpatterns = [
    ...
    url(r'^CRM/OrdenesNEW/(?P<pk>[\w]+)$', OrdenNewCreateView.as_view(), name='OrdenCreateIndex'),
    url(r'^CRM/Orden/(?P<pk>[\w]+)$', OrdenDetailView.as_view(), name='OrdenDetailIndex'),
